...
exports.Find = function (id) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (id) { //if a condition is sent then find all documents with that condition
...
exports.Update_Car = function (newCar) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        Car.findByIdAndUpdate(newCar._id, newCar, { new: true }, function (err, data) {
